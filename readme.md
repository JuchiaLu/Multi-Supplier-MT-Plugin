...
| ---------------------------------------------------- | ---------------------------------------------------- | ------------------------- | ------------ | ---------------- | ------------------ | -------------- | -------------------- |
| [阿里](https://www.aliyun.com/product/ai/base_alimt) | 普通版：每月 100 万字符<br />专业版：每月 100 万字符 | 普通版：50<br/>专业版：50 | ✔            | ✔ (Html)         | 10                 | 10             | 50                   |
| [腾讯](https://cloud.tencent.com/product/tmt)        | 每月 500 万字符                                      | 5                         | ✔            | ×                | 10                 | 4              | 5                    |
| [百度](https://fanyi-api.baidu.com/product/11)       | 标准版：每月 5 万字符<br/>高级版：每月 100 万字符    | 标准版：1<br />高级版：10 | ?            | ×                | 1                  | 1              | 1                    |
| [火山](https://translate.volcengine.com/api)         | 每月 200 万字符                                      | 10                        | ✔            | ×                | 10                 | 5              | 10                   |
| [小牛](https://niutrans.com/dev-page)                | 每日 20 万字符                                       | 50                        | ×            | ✔  (Xml)         | 1                  | 10             | 50                   |
| [有道](https://fanyi.youdao.com/openapi/)            | 新用户赠送 50 元体验金                               | 50                        | ✔            | ×                | 10                 | 1              | 50                   |
| [讯飞](https://www.xfyun.cn/services/xftrans)        | 新用户赠送 200 万字符（90 天内有效）                 | 不详                      | ×            | ✔ (Xml)          | 1                  | 3              | 10                   |
| [彩云](https://platform.caiyunapp.com/)              | 新用户赠送 100 万字符（30 天内有效）                 | 10                        | ✔            | ×                | 10                 | 8              | 10                   |
|                                                      |                                                      |                           |              |                  |                    |                |                      |
| 谷歌（逆向）                                         | 且用且珍惜                                           | 不详                      | ×            | ✔ (Xml 或 Html)  | 1                  | 5              | 10                   |
| 微软（逆向）                                         | 且用且珍惜                                           | 不详                      | ✔            | ×                | 10                 | 5              | 10                   |
|                                                      |                                                      |                           |              |                  |                    |                |                      |
| [OpenAI GPT](https://platform.openai.com/)           | 无                                                   | 由用户等级决定            | ×            | ✔ (Xml 或 Html)  | 1                  | 50             | 50                   |
| [Azure GPT](https://aka.ms/azure-openai)             | 无                                                   | 由用户等级决定            | ×            | ✔ (Xml 或 Html)  | 1                  | 55             | 55                   |
|                                                      |                                                      |                           |              |                  |                    |                |                      |
| [Papago](https://papago.naver.com/)                  | 每天 1 万字符                                        | 不详                      | ×            | ? (Html)         | 1                  | 5              | 10                   |
