...
{
    public class ServiceTencent : MultiSupplierMTServiceInterface
    {
        ...
        {
            new OptionsFormTencent(options, environment).ShowDialog(parentForm);
        ...
        public static async Task<bool> Check(string appId, string appKey)
        {
            ...
            var service = new ServiceTencent();
            try
            {
