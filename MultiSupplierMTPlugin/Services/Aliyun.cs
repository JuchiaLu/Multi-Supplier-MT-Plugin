...
{
    public class Aliyun : MultiSupplierMTService
    {
        ...
        {
            using (var form = new Forms.FormAliyun(options, environment))
            {
