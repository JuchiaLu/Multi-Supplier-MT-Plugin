...
{
    public partial class FormNiutrans : Form
    {
        ...
        public FormNiutrans(MultiSupplierMTOptions options, IEnvironment environment)
        {
            InitializeComponent();
        ...
        {
             Text = LLH.G(LLK.FormNiutrans);

            labelApikey.Text = LLH.G(LLK.FormNiutrans_LabelApikey);
        ...
        private async void linkLabelCheck_Click(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            checkSuccess = await Niutrans.Check(textBoxApikey.Text);
        ...
        private void buttonHelp_Click(object sender, EventArgs e)
        {
            try
            {
                Process.Start("https://niutrans.com/dev-page");
            }
            catch
            {
                // do nothing
