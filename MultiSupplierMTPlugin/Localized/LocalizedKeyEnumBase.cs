...
namespace MultiSupplierMTPlugin.Localized
{
    public class LocalizedKeyEnumBase
    {
        ...
        public static bool TryFromName<TEnum>(string name, out TEnum result) where TEnum : LocalizedKeyEnumBase
        {
            FieldInfo[] fields;
